        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Same item may be assigned to different helpers"),
                ),
                (
                    "admins",
                    models.ManyToManyField(
                        blank=True, to=settings.AUTH_USER_MODEL, verbose_name="Administrators of inventory"
                    ),
                ),
            ],
        ),
