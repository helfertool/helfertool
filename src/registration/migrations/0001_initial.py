    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "imprint",
                    django_bleach.models.BleachField(
                        blank=True, help_text="Display at the bottom of the registration form.", verbose_name="Imprint"
                    ),
                ),
                (
                    "imprint_de",
                    django_bleach.models.BleachField(
                        null=True,
                        blank=True,
                        help_text="Display at the bottom of the registration form.",
                ...
                (
                    ...
                    django_bleach.models.BleachField(
                        null=True,
                        blank=True,
                        help_text="Displayed after registration.",
                        verbose_name="Text after registration",
                    ),
                ),
                (
                    "registered_en",
                ...
                (
                    ...
                    models.IntegerField(
                        null=True,
                        blank=True,
                        help_text="If two shifts overlap more than this value in minutes it is not possible to register for both shifts. Leave empty to disable this check.",
                        verbose_name="Maximal overlapping of shifts",
                    ),
                ),
                ...
                (
                    "ask_full_age",
                    models.BooleanField(default=True, verbose_name="Helpers have to confirm to be full age"),
                ),
                (
                    "show_public_numbers",
                    models.BooleanField(default=True, verbose_name="Show number of helpers on registration page"),
                ),
                (
                    "mail_validation",
                    models.BooleanField(
                        default=True,
                        verbose_name="Registrations for public shifts must be validated by a link that is sent per mail",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("No", "I never got an instruction"),
                            ("Yes", "I have a valid instruction"),
                            ("Refresh", "I got a instruction by a doctor, it must be refreshed"),
                        ],
                        max_length=20,
                        blank=True,
                        verbose_name="Instruction for the handling of food",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "infection_instruction",
                    models.BooleanField(default=False, verbose_name="Instruction for the handling of food necessary"),
                ),
                ...
                (
                    "badge_defaults",
                    models.OneToOneField(null=True, to="badges.BadgeDefaults", blank=True, on_delete=models.CASCADE),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blocked",
                    models.BooleanField(
                        default=False, verbose_name="If the job is publicly visible, the shift is blocked."
                    ),
                ),
