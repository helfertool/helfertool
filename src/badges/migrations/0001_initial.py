        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    models.ImageField(
                        null=True, upload_to=badges.models.badge._badge_upload_path, blank=True, verbose_name="Photo"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bg_front",
                    models.ImageField(
                        upload_to=badges.models.design._design_upload_path, verbose_name="Background image for front"
                    ),
                ),
                (
                    "bg_back",
                    models.ImageField(
                        upload_to=badges.models.design._design_upload_path, verbose_name="Background image for back"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=200,
                        help_text='This name is used for the LaTeX template, the prefix "perm-" is added.',
                        verbose_name="Name for LaTeX template",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=200,
                        help_text="This name is used for the LaTeX template.",
                        verbose_name="Name for LaTeX template",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "latex_template",
                    models.FileField(
                        null=True, upload_to=badges.models.settings._settings_upload_path, verbose_name="LaTeX template"
                    ),
                ),
                (
                    "rows",
                    models.IntegerField(
                        ...
                        verbose_name="Number of rows on one page",
                    ),
                ),
                (
                    "columns",
                    models.IntegerField(
                        default=2,
                        validators=[django.core.validators.MinValueValidator(1)],
                        verbose_name="Number of columns on one page",
                    ),
                ),
                (
                    "barcodes",
                    models.BooleanField(default=False, verbose_name="Print barcodes on badges to avoid duplicates"),
                ),
                (
                    "coordinator_title",
                    models.CharField(default="", max_length=200, verbose_name="Role for coordinators"),
                ),
